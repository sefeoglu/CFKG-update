...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", type=str, default="../llm-catastrophic-re/fewrel_corrected_results/fewrel_mas_top_prob_5/model_5/test_pred_1.json", help="Path to the input file containing predictions.")
    parser.add_argument("--output_file", type=str, default="../llm-catastrophic-re/rationale_nli/fewrel_mas_top_prob_5/model_5/test_pred_1.json", help="Path to the output file to save generated prompts.")
