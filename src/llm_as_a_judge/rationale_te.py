...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", type=str, default="../llm-catastrophic-re/last_results/tacred/probs/tacred_mas_top_prob_5/model_4/test_pred_1.json", help="Path to the input file containing predictions.")
    parser.add_argument("--output_file", type=str, default="../llm-catastrophic-re/rationale/gemini/tacred_mas_top_prob_5/model_4/test_pred_1.json", help="Path to the output file to save generated prompts.")
