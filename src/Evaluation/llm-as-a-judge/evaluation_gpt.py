...
def main(args):
    ...
    for run_id in range(1, 6):
        for task_id in range(8,9):
            ...
            preds = [item['prediction'] for item in prediction_data]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--predictions", type=str, default="/Users/sefika/phd_projects/llm-catastrophic-re/results_all/results_rationale_nli/gemini/fewrel_mas_top_prob_5/", help="Path to the JSON file containing predictions.")
