...
def get_templates(sentence: str, head_entity: str, tail_entity: str, candidate_relation_type_and_probability: str, prediction: str) -> str:
    ...
    [CANDIDATE RELATION TYPE AND PROBABILITY]: 
...
def generate_rationale_prompt(predictions) -> str:
    ...
    for prediction in tqdm(predictions, desc="Generating prompts"):
        ...
        sentence, head_entity, tail_entity = get_entites_sentence(prompt)
        prediction['rationale_prompt'] = get_templates(sentence, head_entity, tail_entity, candidates, relation_prediction)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file", type=str, default="/Users/sefika/phd_projects/llm-catastrophic-re/last_results/tacred/probs/tacred_mas_top_prob_5/model_4/test_pred_1.json", help="Path to the input file containing predictions.")
    parser.add_argument("--output_file", type=str, default="/Users/sefika/phd_projects/llm-catastrophic-re/rationale/gemini/tacred_mas_top_prob_5/model_4/test_pred_1.json", help="Path to the output file to save generated prompts.")
